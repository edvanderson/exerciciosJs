...
console.log(texto.replace( /Manuel Marques de Souza/,' Edvanderson Barbosa Lisboa'));
/*
...
// ?
console.log(texto.replace(/brasileiro/,'Paraense'));
/*
...
// ?
console.log(texto.replace(/[a]/gi,'4'));//[a|A]
/*
